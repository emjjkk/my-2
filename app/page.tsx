...
export default function PortfolioPage() {
  ...
  return (
    <main
      id="portfolio-main"
      className="min-h-screen transition-colors duration-200 bg-[var(--paper)] text-[var(--ink)] font-light"
    >
        ...
        <div className="w-full max-w-2xl mx-auto px-5 sm:px-6 py-8 sm:py-12 space-y-12 sm:space-y-14">
          ...
          <section id="about-section" className="space-y-4">
            <div className="space-y-1">
              ...
              <p className="font-mono-ink text-md opacity-60 tracking-wider">
            ...
            >
              You can call me Thursday. I'm a Thai-Nigerian dev based in
              Rwanda, currently building full-stack web applications with a focus on
              performance and optimization. I also build native mobile and desktop apps as well as
              third-party integrations.
            </p>

            <a href="/Emmanuel_Alabi_Resume_Updated_v10.pdf" target="_blank" rel="noreferrer">
          ...
          <section id="notes-section" className="space-y-6">
            <div className="flex justify-between items-baseline">
              <h2
                id="notes-heading"
                className="text-lg sm:text-xl font-regular tracking-tight"
              >
                Blog
              </h2>
                ...
                >
                  <div className="flex items-baseline justify-between flex-wrap gap-2">
                    <div className="flex items-baseline gap-2.5">
                      <h3 className="text-base sm:text-lg font-medium group-hover:underline underline-offset-4">
                        {project.title}
                      </h3>
          ...
          <section id="contact-section" className="space-y-5">
            ...
            <div className="space-y-2.5 font-mono-ink text-xs sm:text-sm">
              ...
              <div className="flex justify-between items-center py-1 border-b border-dashed border-current opacity-80 border-opacity-80">
